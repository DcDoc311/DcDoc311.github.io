...
이 글은 TI XDCTools와 SYS/BIOS의 구성을 공부하는 과정에서 시작되었습니다. XDCTools를 학습하던 중 RTSC라는 개념에 대해 궁해졌고, 이를 정리하기 위해 아래 출처를 기반으로 정리했습니다. 다만, 현재 RTSC 개념은 안타깝게도 개발자들에게 선택 받지 못한 것으로 보입니다.
